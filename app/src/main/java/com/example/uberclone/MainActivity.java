...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
            ...
            if (ParseUser.getCurrentUser() == null){
                ParseAnonymousUtils.logIn(new LogInCallback() {
                    ...
                    public void done(ParseUser user, ParseException e) {
                        if (user !=null && e == null){
                            Toast.makeText(MainActivity.this, "We have am anonymous user", Toast.LENGTH_SHORT).show();
    ...
    private RadioButton passangerRadioButton,driverRadioButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passangerRadioButton = findViewById(R.id.passangerRadioButton);
        ...
        btnSignUpLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (state == State.SIGNUP){
                    if (driverRadioButton.isChecked() == false && passangerRadioButton.isChecked() == false){
    ...
    private void  transitionToPassengerActivity(){
        if (ParseUser.getCurrentUser() != null){
            if (ParseUser.getCurrentUser().get("as").equals("Passenger")){
                Intent intent = new Intent(MainActivity.this, PassengerAcivity.class);
