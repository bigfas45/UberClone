...
public class PassengerAcivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passenger_acivity);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            ...
            if (ContextCompat.checkSelfPermission(PassengerAcivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(PassengerAcivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1000);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1000 && grantResults.length > 0 &&  grantResults[0] == PackageManager.PERMISSION_GRANTED){
            ...
            if (ContextCompat.checkSelfPermission(PassengerAcivity.this,  Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                Location currentPassengerLoaction = locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER);
                updateCameraPassengerLocation(currentPassengerLoaction);
            }
        }
                ...
                if (passengerCurrentLocation != null) {
                    ...
                    requestCar.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                Toast.makeText(PassengerAcivity.this, "A car request is sent", Toast.LENGTH_SHORT).show();
            ...
            carRequestQuery.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> requestList, ParseException e) {
                    if (requestList.size() > 0 && e == null){
                        ...
                        btnRequestCar.setText("Request a new ride");
                        ...
                        for (ParseObject uberRequest : requestList){
                            uberRequest.deleteInBackground(new DeleteCallback() {
                                ...
                                public void done(ParseException e) {
                                    if (e == null){
                                        Toast.makeText(PassengerAcivity.this, "Request Deleted ", Toast.LENGTH_SHORT ).show();
                                    }
                                }
                            });
